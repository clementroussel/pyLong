...
class sProfile:
    ...
    def update(self):
        ...
        self.trickLine.set_marker(markerStyles[self.marqueur['style']])
        ...
        self.trickLine.set_markeredgecolor(colors[self.marqueur['color']])
        ...
        self.trickLine.set_markerfacecolor(colors[self.marqueur['color']])
        ...
        self.trickLine.set_markersize(self.marqueur['size'])
